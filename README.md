...
The data was cleaned and analysed in Python to examine and compare economic trends amongst UK regions from 2008 to 2023. With the common rhetoric that London is pulling away from the rest of the UK, this project explores whether other UK regions were able to recover from the 2008 financial crash, and examines how far the economic gap between London and the rest has widened or narrowed since. Regional GVA (output) and GDHI (income) per head were each indexed to 2008 = 100 to allow fair comparison of growth across regions with different starting levels and Compound Annual Growth Rate (CAGR) was calculated across three sub-periods (2008–2016, 2016–2019, and 2019–2023) to identify when divergence occurred. Visualisations were created using Python and are presented throughout this report.
